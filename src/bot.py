...
class Bot:
    ...
    async def _on_callback(self, update: Update, ctx: ContextTypes.DEFAULT_TYPE):
        ...
        if data.startswith(CB_PERM_APPROVE):
            ...
            ok = self._orchestrator.resolve_permission(request_id, approved=True, reason="Approved")
        ...
        # Permission: Deny
            ...
            ok = self._orchestrator.resolve_permission(request_id, approved=False, reason="Denied")
        ...
        # Clarification: option selected
            ...
            ok = self._orchestrator.resolve_clarification(request_id, q["question"], chosen_label)
    ...
    async def _on_message(self, update: Update, ctx: ContextTypes.DEFAULT_TYPE):
        ...
        await self._orchestrator.route_message(chat_id, text, send_reply)
    ...
    async def _cmd_start(self, update: Update, ctx: ContextTypes.DEFAULT_TYPE):
        ...
        await update.message.reply_text(
            ...
            "  <text> — channel note (ambient, injected on next interaction)\n\n"
